...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public JsonResult ObtenerDepartamento()
        {
            ...
            return Json(new { oLista = oLista }, JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public JsonResult ObtenerBarrio(string IdDepartamento, string IdCiudad)
        {
            List<Barrio> oLista = new List<Barrio>();

            oLista = new CN_Ubicacion().ObtenerBarrio(IdDepartamento, IdCiudad);
